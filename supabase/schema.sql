...
--  Navn kan sendes via metadata. Rolle settes alltid til agent her og
--  oppgraderes kun server-side fra en autoritativ invitasjonsrad.
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
--  USER INVITATIONS (lederstyrt aktivering)
-- ---------------------------------------------------------------------------
...
comment on table public.user_invitations is
  'Engangsinvitasjoner opprettet av ledere. Bare SHA-256-hash av token lagres.';

revoke execute on function public.handle_new_user() from public, anon, authenticated;
revoke execute on function public.set_updated_at() from public, anon, authenticated;

-- Atomisk vern mot nye kunde- og avtaleduplikater. Eksisterende testdata
-- beholdes til en kontrollert sammenslåing kan flytte alle relasjoner.
