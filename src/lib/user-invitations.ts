...
export function invitationEmail(input: {
  ...
  return {
    ...
    text: `${hasName ? `Hei ${input.fullName}.` : "Hei."} ${input.inviterName} har invitert deg til Reachr som ${roleLabel}. Du velger selv navn, profilbilde og passord når du aktiverer kontoen innen 72 timer: ${input.acceptUrl}`,
