...
// Nøkkelord → NACE-kode (Brønnøysund matcher på prefiks, så «43.21» treffer
// «43.210»). Mer spesifikke koder gir finere treff på hva bedriften faktisk
// gjør. Rekkefølge = prioritet (første treff vinner) – spesifikke ord først.
export const NACE_KEYWORDS: Record<string, string> = {
  // ── Håndverk / installasjon (finkornet) ──
  elektriker: "43.21",
  elektro: "43.21",
  "el-installasjon": "43.21",
  rørlegger: "43.22",
  rør: "43.22",
  vvs: "43.22",
  ventilasjon: "43.22",
  ...
  dekk: "45.20",
  bil: "45",
  // ── Eiendom / servering / velvære / helse / utdanning ──
  eiendomsmegler: "68.31",
  eiendom: "68",
  utleie: "68.20",
  restaurant: "56.10",
  catering: "56.21",
